...
// modules are used to encapsulate code , to break down problem in smaller parts
...
const {firstName} = require('./5-names') // importing firstName variable of name.js module
